...
// silakan taruh code kalian di bawah
    ...
    //     $tinggikuadrat = $tinggi_badan * $tinggi_badan;
    //     $BMI = $berat_badan/$tinggikuadrat;
    // }

    $berat_badan = isset($_POST["berat_badan"]) ? $_POST["berat_badan"] : 0;
    $tinggi_badan = isset($_POST["tinggi_badan"]) ? $_POST["tinggi_badan"] : 0;
...
// silakan taruh code kalian di bawah
    if(($tinggi_badan =!intval($tinggi_badan)) || ($berat_badan =!intval($berat_badan))) {
        echo"isi integer";
        $Error = "isi integer";
    }
// **********************  2  ************************** 
